...
/* Stil za sliku Ruskog doma */
.img-ruski-dom {
    display: block;
    width: 250px;   /* Širina */
    height: 180px;  /* Visina */
    margin: 20px auto;
    object-fit: contain; /* Sprečava razvlačenje slike */
    border-radius: 4px;
}

/* Stil za sliku Izaslanika odbrane - znatno manja */
.img-izaslanik {
    display: block;
    width: 80px;    /* Širina */
    height: 100px;  /* Visina */
...
<p>Pomaže ambasadoru u obavljanju političkih i analitičkih zadataka.</p>
</div>`,
...
<p>Obavlja poslove zaštite prava i interesa državljana Ruske Federacije.</p>
</div>`,

odbr: `
<div class="card">
<h2>Aparat Izaslanika odbrane</h2>
<img src="izaslanik_odbrane.png" alt="Izaslanik odbrane" class="img-izaslanik">
...
<img src="Ruski dom12345.png" alt="Logo Ruski dom" class="img-ruski-dom">
